...
if(isset($_POST['fIdUsuario']) && $_POST['fIdUsuario'] != 0 && $_POST['fIdUsuario'] != ""){
	...
	if(is_object($oUsuario)){
		...
		$sObjetoLogado = "Usuário ".utf8_decode($oUsuario->getNmUsuario())." liberou a disponibilidade de novo login para o usuário: ".utf8_decode($oUsuario->getLogin());
		$oTransacaoLogado = $oFachadaSeguranca->inicializaTransacao("",$nIdTipoTransacaoLogado,$oUsuario->getId(),utf8_encode($sObjetoLogado),IP_USUARIO,DATAHORA,1,1);
