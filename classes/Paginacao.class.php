...
class Paginacao {
	...
	*/
	...
	function retornaLinhaDeLinks(){
		...
		if($nPaginaAtual > 1)
			$sLinhaPaginacao .= '<a href="'.$this->sNomePaginaOrigem.'?'.$this->sNomeVariavelDePaginas.'='.($nPaginaAtual-1).$this->retornaStringProLink().'"><img src="/painel/imagens/paginacao/reg_anterior.gif" width="16" height="16" class="anterior" alt="Anterior" title="Anterior" border="0" /></a>&nbsp;';
		else	
			$sLinhaPaginacao .= '<img src="/painel/imagens/paginacao/reg_anterior_inativo.gif" width="16" height="16" class="anterior" alt="Anterior" title="Anterior" border="0" />&nbsp;';
		
		if($nPaginaAtual < $this->nQuantidadePaginas)
			$sLinhaPaginacao .= '<a href="'.$this->sNomePaginaOrigem.'?'.$this->sNomeVariavelDePaginas.'='.($nPaginaAtual+1).$this->retornaStringProLink().'"><img src="/painel/imagens/paginacao/reg_proximo.gif" width="16" height="16" class="proximo" alt="Pr&oacute;xima" title="Pr&oacute;xima" border="0" /></a>';
		else	
			$sLinhaPaginacao .= '<img src="/painel/imagens/paginacao/reg_proximo_inativo.gif" width="16" height="16" class="proximo" alt="Pr&oacute;xima" title="Pr&oacute;xima" border="0" />';
