...
var $bAtivo;
	...
	* @param $dDtUsuario DtUsuario
	* @param $bPublicado Publicado
	* @param $bAtivo Ativo
	*/
	
	/*
	function Usuario($nId,$nIdGrupoUsuario,$sNmUsuario,$sLogin,$sSenha,$sEmail,$bLogado,$dDtUsuario,$bPublicado,$bAtivo){
		$this->setId($nId);
	...
	*/
	...
	/**
	* Recupera o valor do atributo $dDtUsuario. 
	* @return $dDtUsuario DtUsuario
	*/
	function getDtUsuario(){
		return $this->dDtUsuario;
	}
	/**
	* Atribui valor ao atributo $dDtUsuario. 
	* @param $dDtUsuario DtUsuario
	* @access public
	*/
	function setDtUsuario($dDtUsuario){
		$this->dDtUsuario = $dDtUsuario;
	}
