...
class FachadaSegurancaBDParent {
	...
	*/	
	function inicializaErrosMysql($nId,$sErro,$nIdUsuario,$sIp,$dDtErro,$bPublicado,$bAtivo) {
		$oErrosMysql = new ErrosMysql($nId,$sErro,$nIdUsuario,$sIp,$dDtErro,$bPublicado,$bAtivo);
		return $oErrosMysql;
	}
	...
	* @return boolean $bResultado Indicando sucesso ou não da operação;
	*/
	function insereErrosMysql($oErrosMysql,$oTransacao,$sBanco) {
		$oErrosMysqlBD = $this->inicializaErrosMysqlBD($sBanco);
	...
	* @return boolean $bResultado Indicando presença ou ausência de ErrosMysql
	*/
	function alteraErrosMysql($oErrosMysql,$oTransacao,$sBanco) {
		$oErrosMysqlBD = $this->inicializaErrosMysqlBD($sBanco);
	...
	* @return boolean $bResultado Indicando sucesso ou não da operação
	*/
	function excluiErrosMysql($nId,$oTransacao,$sBanco) {
		$oErrosMysqlBD = $this->inicializaErrosMysqlBD($sBanco);
	...
	* @return boolean $bResultado Indicando sucesso ou não da operação
	*/
	function desativaErrosMysql($nId,$oTransacao,$sBanco) {
		$oErrosMysqlBD = $this->inicializaErrosMysqlBD($sBanco);
