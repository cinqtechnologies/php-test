...
var $bAtivo;
	...
	*/
	...
	/*
	function ErrosMysql($nId,$sErro,$nIdUsuario,$sIp,$dDtErro,$bPublicado,$bAtivo){
		$this->setId($nId);
		$this->setErro($sErro);
	...
	*/
	...
	/**
	* Recupera o valor do atributo $dDtErro. 
	* @return $dDtErro DtErro
	*/
	function getDtErro(){
		return $this->dDtErro;
	}
	/**
	* Atribui valor ao atributo $dDtErro. 
	* @param $dDtErro DtErro
	* @access public
	*/
	function setDtErro($dDtErro){
		$this->dDtErro = $dDtErro;
	}
